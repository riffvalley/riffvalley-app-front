<template>
    <div v-if="show" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
        ...
        <div class="bg-white dark:bg-rv-darkCard rounded-lg p-6 w-full max-w-md shadow-xl">
            <h3 class="text-lg font-bold mb-4 text-gray-900 dark:text-white">Editar Contenido</h3>

            <div class="space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipo</label>
                    <select v-model="formData.type"
                        class="w-full border border-gray-300 dark:border-white/20 dark:bg-rv-darkSurface dark:text-gray-200 rounded-lg px-3 py-2 disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-rv-darkBg dark:disabled:text-gray-600"
                    ...
                    <p v-if="formData.type === 'spotify'" class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                ...
                <div v-if="formData.type === 'radar'">
                    <div v-if="formData.listDate" class="mb-4 text-sm text-gray-600 dark:text-gray-400">
