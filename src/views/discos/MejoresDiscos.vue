<template>
  <div class="p-4 min-h-screen bg-gray-50/50 dark:bg-rv-darkBg">
    <div class="max-w-7xl mx-auto">
      <h1 class="text-2xl font-bold mb-4 text-gray-800 dark:text-white">Mejores del Mes</h1>

      <!-- Listas Actuales -->
      <section class="mb-6">
        <div class="flex items-center gap-2 mb-3">
          <div class="p-1.5 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg">
            <i class="fa-solid fa-star text-indigo-600 dark:text-indigo-400 text-lg"></i>
          </div>
