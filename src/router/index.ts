...
const routes: Array<RouteRecordRaw> = [
  ...
  },
  {
    path: "/events/rooms",
    name: "EventsRooms",
    component: () => import("@views/events/Rooms.vue"),
    meta: { requiresAuth: true },
  },
  {
    path: "/events/rooms/manage",
    name: "ManageRooms",
    component: () => import("@views/events/ManageRooms.vue"),
    meta: { requiresAuth: true, requiresRole: "riffValley" },
  },
  {
    path: "/events/rooms/manage/create",
    name: "CreateRoom",
    component: () => import("@views/events/CreateRoom.vue"),
    meta: { requiresAuth: true, requiresRole: "riffValley" },
  },
  {
    path: "/events/rooms/manage/:id/edit",
    name: "EditRoom",
    component: () => import("@views/events/EditRoom.vue"),
    meta: { requiresAuth: true, requiresRole: "riffValley" },
    props: true,
  },
  {
    path: "/events/rooms/:province",
    name: "RoomsByProvince",
    component: () => import("@views/events/RoomsByProvince.vue"),
    meta: { requiresAuth: true },
    props: true,
  },
  {
    path: "/events/rooms/:province/:room",
    name: "RoomDetail",
    component: () => import("@views/events/RoomDetail.vue"),
    meta: { requiresAuth: true },
    props: true,
  },
  {
