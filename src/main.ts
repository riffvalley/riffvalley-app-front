...
import { faBookmark, faHeart, faPen, faTrash, faCloudArrowUp, faCamera } from '@fortawesome/free-solid-svg-icons';

// Agregar iconos a la librería de FontAwesome
library.add(faBookmark, faHeart, faPen, faTrash, faCloudArrowUp, faCamera);
